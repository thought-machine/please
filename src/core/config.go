...
type Configuration struct {
	...
	Python struct {
		...
		DefaultIndex        string   `help:"The default index used to look for and download python wheels." var:"DEFAULT_WHEEL_INDEX"`
		...
		UsePyPI             bool     `help:"Whether to use PyPI for pip_library rules or not. Defaults to true, if you disable this you will presumably want to set DefaultPipRepo to use one of your own.\nIs overridden by the use_pypi argument to pip_library." var:"USE_PYPI"`
