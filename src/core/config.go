...
type Configuration struct {
	...
	Bazel        struct {
		PreloadedSubincludes []string `help:"Subinclude targets to preload when parsing in bazel compatibility mode. Similar to PreloadSubincludes." example:"///plugins/cc//build_defs:cc"`
