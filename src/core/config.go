...
type Configuration struct {
	...
	Python struct {
		...
		DisableVendorFlags  bool    `help:"Disables injection of vendor specific flags for pip in pip_library. The option can be useful if you are using something like Pyenv, and therefore vendor specific patches might stop pip from executing successfully." var:"DISABLE_VENDOR_FLAGS"`
