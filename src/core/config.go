...
type Configuration struct {
	...
	Python struct {
		...
		StripPleasePackageNames bool     `help:"It makes the python modules to be built at the top level instead of the package path they reside in.\nThis way, imports to workspace python modules look like a regular import for a locally installed package." var:"PYTHON_STRIP_PLEASE_PACKAGE_NAMES"`
