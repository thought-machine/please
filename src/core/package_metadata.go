...
type packageMetadataImpl struct {
	...
	targetToStmt map[*BuildTarget]BuildStatement
	...
	// the target.
	targetToRequiredSubincludes map[*BuildTarget]BuildLabels
...
func (m *packageMetadataImpl) RegisterRequiredSubinclude(target *BuildTarget, labelProvider SubincludesLabelProvider) {
	...
	m.mutex.Lock()
	defer m.mutex.Unlock()
	m.targetToRequiredSubincludes[target] = append(m.targetToRequiredSubincludes[target], labels...)
}
...
func (m *packageMetadataImpl) FindStatement(target *BuildTarget) *BuildStatement {
	...
	if stmt, present := m.targetToStmt[target]; present {
		return &stmt
	}
...
func (m *packageMetadataImpl) FindRequiredSubincludes(target *BuildTarget) BuildLabels {
	...
	return m.targetToRequiredSubincludes[target]
}
