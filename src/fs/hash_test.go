...
func TestHash(t *testing.T) {
	...
	b1, err1 := h.Hash("test_data/test_subfolder1/a.txt", false, false)
	b2, err2 := h.Hash("test_data/test_subfolder1/a.txt", false, false)
...
func TestMoveHash(t *testing.T) {
	...
	h := NewPathHasher(wd, true, sha1.New, "")
	b1, err1 := h.Hash("test_data/test_subfolder1/a.txt", false, false)
	h.MoveHash("test_data/test_subfolder1/a.txt", "doesnt_exist.txt", true)
...
func TestHashConstructorSHA1(t *testing.T) {
	...
	require.NoError(t, err)
	h := NewPathHasher(wd, true, sha1.New, "")
	b, err := h.Hash("test_data/test_subfolder1/a.txt", false, false)
