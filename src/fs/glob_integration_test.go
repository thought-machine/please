...
func TestCanGlobFileInRoot(t *testing.T) {
	...
	if _, err := os.Lstat("src/fs/test_data/test.txt"); err != nil {
...
func TestCanGlobFileInSubDirectory(t *testing.T) {
	...
	if _, err := os.Lstat("src/fs/test_data/test_subfolder1/a.txt"); err != nil {
...
func TestCannotGlobFileInSubPackage(t *testing.T) {
	...
	if _, err := os.Lstat("src/fs/test_data/test_subfolder2/b.txt"); err == nil {
