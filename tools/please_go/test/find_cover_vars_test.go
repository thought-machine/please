...
func TestFindCoverVars(t *testing.T) {
	vars, err := FindCoverVars("tools/please_go/test/test_data", "", "", []string{"tools/please_go/test/test_data/x", "tools/please_go/test/test_data/binary"}, nil)
...
func TestFindBinaryCoverVars(t *testing.T) {
	...
	vars, err := FindCoverVars("tools/please_go/test/test_data/binary", "", "", nil, nil)
	assert.NoError(t, err)
	assert.Equal(t, expected, vars)
}

func TestFindCoverVarsExcludesSrcs(t *testing.T) {
	vars, err := FindCoverVars("tools/please_go/test/test_data/binary", "", "", nil, []string{"tools/please_go/test/test_data/binary/lock.go"})
	assert.NoError(t, err)
