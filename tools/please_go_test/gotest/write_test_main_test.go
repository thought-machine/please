...
func TestParseTestSources(t *testing.T) {
	descr, err := parseTestSources([]string{"test_data/test/example_test.go"})
...
func TestParseTestSourcesWithMain(t *testing.T) {
	descr, err := parseTestSources([]string{"test_data/main/example_test_main.go"})
	assert.NoError(t, err)
...
func TestWriteTestMain(t *testing.T) {
	err := WriteTestMain(
		"test_data",
		"",
		[]string{"test_data/test/example_test.go"},
		"test.go",
		false,
		[]CoverVar{},
		false,
...
func TestWriteTestMainWithBenchmark(t *testing.T) {
	err := WriteTestMain(
		"test_data",
		"",
		[]string{"test_data/bench/example_benchmark_test.go"},
		"test.go",
		true,
		[]CoverVar{},
		true,
