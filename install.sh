...
cp plz-out/bin/src/please ${DEST}/please
chmod 0775 ${DEST}/please
ln -sf ${DEST}/please ${DEST}/plz
cp plz-out/bin/src/libplease_parser_*.so ${DEST}
chmod 0664 ${DEST}/libplease_parser_*.so
cp plz-out/bin/src/build/python/please_pex ${DEST}/please_pex
chmod 0775 ${DEST}/please_pex
cp plz-out/bin/src/build/java/junit_runner.jar ${DEST}/junit_runner.jar
chmod 0664 ${DEST}/junit_runner.jar
cp plz-out/bin/src/build/java/jarcat ${DEST}/jarcat
chmod 0775 ${DEST}/jarcat
cp plz-out/bin/src/build/java/please_maven ${DEST}/please_maven
chmod 0775 ${DEST}/please_maven
cp plz-out/bin/src/cache/main/cache_cleaner ${DEST}/cache_cleaner
chmod 0775 ${DEST}/cache_cleaner
cp plz-out/bin/src/misc/please_diff_graphs ${DEST}/please_diff_graphs
chmod 0775 ${DEST}/please_diff_graphs
cp plz-out/bin/src/build/go/please_go_test ${DEST}/please_go_test
chmod 0775 ${DEST}/please_go_test
cp plz-out/bin/src/lint/please_build_linter ${DEST}/please_build_linter
